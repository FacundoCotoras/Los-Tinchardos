...
('Agustin', 'Panaza', 42156789, 'Avellaneda 742', 116543219),
('Santiago', 'Villa', 39874512, 'Belgrano 1550', 117892341),
('Benjamin', 'Peru', 44789123, 'Sarmiento 923', 115673421),
('Diana', 'Zeballos', 40987654, 'Mitre 456', 113456782),
('Sharon', 'Pera', 43567891, 'San Martin 188', 119876543);

insert into coches (matricula, modelo, marcha, color) values
('ZX123CD', 'Corolla', 'Toyota', 'Rojo'),
('EP556GH', 'Civic', 'Honda', 'Negro'),
('IJ745KL', '208', 'Peugeot', 'Blanco'),
('YU321OP', 'Focus', 'Ford', 'Azul'),
('QR651VT', 'Cronos', 'Fiat', 'Gris');
